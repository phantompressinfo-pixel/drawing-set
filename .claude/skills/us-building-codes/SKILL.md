...
amendment in `code-library/aspen/title-8-…` or `code-library/pitkin/title-11-…`
and cite that.

`references/locally-amended-sections.txt` drives this — **306 sections** across
IBC, IEBC, IPC, IMC, IFGC and IRC, regenerated by
`scripts/extract_amendments.py`.
...
`references/colorado-dpo-amended.txt` drives this — **340 sections**:
