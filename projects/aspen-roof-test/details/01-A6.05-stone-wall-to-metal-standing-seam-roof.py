...
d.note('WEEP VENTS @ 24" O.C. MAX. IN FIRST JOINT ABOVE FLASHING', to=(9.5, -20), side="left")
...
d.verify("WEEPS SET AT 24\" O.C. MAX. PER OFFICE. WALL TYPE W3 ON A5.00 STILL SAYS 33\" O.C. MAX. - "
         "UPDATE A5.00 TO 24\" SO THE SCHEDULE AND DETAILS AGREE.")
